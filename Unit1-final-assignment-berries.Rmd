...
write.csv(b_berry_bearing,"Shiny/b_berry_bearing.csv",row.names=F)
write.csv(b_berry_market,"Shiny/b_berry_market.csv",row.names=F)
```
...
head(bearing)
bearing_value=filter(bearing,Value!=' (NA)'&Value!=' (D)')
```
